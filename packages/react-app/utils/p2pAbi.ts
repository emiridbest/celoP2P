export const contractAddress = "0x04B3E5a904B4d9659729ECcc9137d585647a58a1";
export const abi = [
  ...
  { inputs: [], name: "ReleaseUnsuccesful", type: "error" },
  {
    anonymous: false,
    inputs: [
      {
  ...
  },
  {
    inputs: [
      ...
      { internalType: "string", name: "_bank", type: "string" },
    ],
    name: "addBuyOrder",
    outputs: [],
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "string", name: "bank", type: "string" },
